...
from test_framework.test_framework import CryptosharesTier2TestFramework
...
class MasternodeGovernanceBasicTest(CryptosharesTier2TestFramework):
    ...
    def run_test(self):
        ...
        firstProposal = Proposal(
            "super-cool",
            "https://forum.cryptoshares.org/t/test-proposal",
            2,
