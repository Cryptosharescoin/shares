...
class FullBlockTest(CryptosharesTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure cryptosharesd isn't accepting b26
        ...
        # Extend the b28 chain to make sure cryptosharesd isn't accepting b28
        ...
        # CRYPTOSHARES: timestamp checks disabled for regtest
        ...
        #    Low-S and High-S values (whereas the cryptoshares code has custom code which does so);
