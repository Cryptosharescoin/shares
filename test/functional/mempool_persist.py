...
By default, cryptosharesd will dump mempool on shutdown and
...
class MempoolPersistTest(CryptosharesTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent cryptosharesd from writing mempool.dat to disk. Verify that `savemempool` fails")
