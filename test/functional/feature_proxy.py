...
"""Test cryptosharesd with different proxy configuration.
...
class ProxyTest(CryptosharesTestFramework):
    ...
    def node_test(self, node, proxies, auth, test_onion=True):
        ...
        # Note: cryptosharesd's SOCKS5 implementation only sends atyp DOMAINNAME, even if connecting directly to IPv4/IPv6
