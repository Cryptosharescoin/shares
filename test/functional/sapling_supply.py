...
class SaplingSupplyTest(CryptosharesTestFramework):
    ...
    def run_test(self):
        ...
        # Send 200 SHARES to shield addr1
        self.log.info("Shielding 200 SHARES...")
        ...
        # Deshield 100 coins
        self.log.info("Deshielding 100 SHARES...")
