#!/usr/bin/env python3
# Copyright (c) 2021 The CRYPTOSHARES developers
...
class DIP3Test(CryptosharesTestFramework):
    ...
    def run_test(self):
        ...
        # Note: dmn2 sends (2 * 0.3 SHARES) to the operator, and (2 * 2.7 SHARES) to the owner
        ...
        assert_raises_rpc_error(-5, "invalid CRYPTOSHARES address InvalidPayee",
        ...
        assert_raises_rpc_error(-5, "invalid CRYPTOSHARES address InvalidPayee", controller.protx_update_registrar,
