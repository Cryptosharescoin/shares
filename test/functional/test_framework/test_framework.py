...
class CryptosharesTestFramework():
    ...
    def _initialize_chain(self):
        ...
        def copy_cachedir(origin, destination, num_nodes=MAX_NODES):
            for i in range(num_nodes):
                ...
                initialize_datadir(destination, i)  # Overwrite port/rpcport in shares.conf
        ...
        def clone_cache_from_node_1(cachedir, from_num=4):
            ...
            for i in range(from_num, MAX_NODES):
                ...
                initialize_datadir(cachedir, i)  # Overwrite port/rpcport in shares.conf
    ...
    """
    Create a ProReg tx, which references an 100 SHARES UTXO as collateral.
...
'''
CryptosharesTestFramework extensions
'''
# !TODO: remove after obsoleting legacy system
class CryptosharesTier2TestFramework(CryptosharesTestFramework):
