...
COIN = 100000000 # 1 SHARES in satoshis
...
# Objects that map to cryptosharesd objects, which can be serialized/deserialized
...
class msg_headers:
    ...
    def deserialize(self, f):
        # comment in cryptosharesd indicates these should be deserialized as blocks
