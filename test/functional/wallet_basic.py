...
class WalletTest(CryptosharesTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 SHARES from 1 to 0 using sendtoaddress call.
        ...
        # Node 1 has:
        # - 1 coin of 1.00 SHARES
        # - 7 coins of 250.00 SHARES
        # - 1 coin of 228.9999xxxx SHARES
