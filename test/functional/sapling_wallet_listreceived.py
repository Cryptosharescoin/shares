...
class ListReceivedTest (CryptosharesTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].sendtoaddress(taddr, 6.0) # node_1 in taddr with 6 SHARES.
        ...
        # Send 1 SHARES to shield addr1
        txid = self.nodes[1].shieldsendmany(taddr, [ # node_1 with 6 SHARES sending them all (fee is 0.1 SHARES)
        ...
        # Confirm transaction (2 SHARES from taddr to shield_addr1)
        ...
        txid = self.nodes[1].shieldsendmany(shield_addr1, # shield_addr1 has 2 SHARES, send 0.6 SHARES + 0.05 SHARES fee
