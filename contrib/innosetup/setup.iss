...
#define MyAppName "CRYPTOSHARES Core"
#define MyAppPublisher "2022 CRYPTOSHARES Core Developers"
#define MyAppURL "https://cryptoshares.net"
#define MyAppExeName "cryptoshares-qt.exe"
...
DefaultDirName={autopf}\CRYPTOSHARES
...
OutputDir=.\output
OutputBaseFilename=CRYPTOSHARESSetup
...
DefaultGroupName=CRYPTOSHARES Core
...
[Files]
Source: ".\package\cryptoshares-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\CRYPTOSHARES\CRYPTOSHARES-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\CRYPTOSHARES\CRYPTOSHARES-Qt,strDataDir|{userappdata}\CRYPTOSHARES\}');
  Result := True;
end;
