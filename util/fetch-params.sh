...
Failed to fetch the CRYPTOSHARES zkSNARK parameters!
...
function main() {
    ...
    cat <<EOF
CRYPTOSHARES - fetch-params.sh

This script will fetch the CRYPTOSHARES zkSNARK parameters and verify their
...
EOF
    ...
    then
        ...
        cat >> "$README_PATH" <<EOF
This directory stores common CRYPTOSHARES zkSNARK parameters. Note that it is
