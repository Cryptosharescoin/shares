...
The script [extract-osx-sdk.sh](https://github.com/cryptoshares-project/cryptoshares/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
cryptoshares/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/cryptoshares-project/cryptoshares/blob/master/doc/README_osx.md) for troubleshooting tips.
