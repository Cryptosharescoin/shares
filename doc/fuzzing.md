...
To build CRYPTOSHARES using AFL instrumentation (this assumes that the
...
with certain assembly code from CRYPTOSHARES's code. See [developer notes on sanitizers](https://github.com/CRYPTOSHARES-Project/CRYPTOSHARES/blob/master/doc/developer-notes.md#sanitizers)
