...
#ifndef CRYPTOSHARES_SUPPORT_ALLOCATORS_MT_POOLED_SECURE_H
#define CRYPTOSHARES_SUPPORT_ALLOCATORS_MT_POOLED_SECURE_H
...
#endif // CRYPTOSHARES_SUPPORT_ALLOCATORS_MT_POOLED_SECURE_H
