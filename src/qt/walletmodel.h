...
#ifndef CRYPTOSHARES_QT_WALLETMODEL_H
#define CRYPTOSHARES_QT_WALLETMODEL_H
...
/** Interface to CRYPTOSHARES wallet from Qt view code. */
...
#endif // CRYPTOSHARES_QT_WALLETMODEL_H
