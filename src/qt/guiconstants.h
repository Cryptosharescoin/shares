...
/* Cryptoshares GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "CRYPTOSHARES-New"
#define QAPP_ORG_DOMAIN "cryptoshares.org"
#define QAPP_APP_NAME_DEFAULT "CRYPTOSHARES-Qt"
#define QAPP_APP_NAME_TESTNET "CRYPTOSHARES-Qt-testnet"
