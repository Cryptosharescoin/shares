                                                                    ...
                                                                    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("CRYPTOSHARES") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
/* On x86 add a bit specifier to the version so that users can distinguish between
    ...
    if (about) {
        setWindowTitle(tr("About CRYPTOSHARES"));
        ...
        licenseInfoHTML.replace(uri, "<a style='color: #C44F54;text-decoration:none'  href=\"\\1\">\\1</a>");
        ...
        QString header = "Usage:  cryptoshares-qt [command-line options]                     \n";
...
ShutdownWindow::ShutdownWindow(QWidget* parent, Qt::WindowFlags f) : QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("CRYPTOSHARES is shutting down...") + "<br /><br />" +
