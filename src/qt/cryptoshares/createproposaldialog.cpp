...
#include "qt/cryptoshares/createproposaldialog.h"
#include "qt/cryptoshares/forms/ui_createproposaldialog.h"

#include "qt/cryptoshares/contactsdropdown.h"
...
CreateProposalDialog::CreateProposalDialog(CRYPTOSHARESGUI* parent, GovernanceModel* _govModel, WalletModel* _walletModel) :
    QDialog(parent),
...
void CreateProposalDialog::setupPageOne()
{
    ...
    setEditBoxStyle(ui->labelURL, ui->lineEditURL, "e.g https://forum.cryptoshares/proposals/best_proposal_ever");
...
void CreateProposalDialog::setupPageTwo()
{
    ...
    setEditBoxStyle(ui->labelAmount, ui->lineEditAmount, "e.g 500 SHARES");
...
void CreateProposalDialog::onAddrListClicked()
{
    ...
    if (!menuContacts) {
        ...
        menuContacts = new ContactsDropdown(
                width,
                height,
                dynamic_cast<CRYPTOSHARESGUI*>(parent()),
                this
        );
