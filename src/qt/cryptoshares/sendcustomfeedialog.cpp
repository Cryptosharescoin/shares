...
#include "qt/cryptoshares/sendcustomfeedialog.h"
#include "qt/cryptoshares/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(CRYPTOSHARESGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &CRYPTOSHARESGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
