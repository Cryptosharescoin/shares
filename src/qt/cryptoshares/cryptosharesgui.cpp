...
#include "qt/cryptoshares/cryptosharesgui.h"
...
const QString CRYPTOSHARESGUI::DEFAULT_WALLET = "~Default";

CRYPTOSHARESGUI::CRYPTOSHARESGUI(const NetworkStyle* networkStyle, QWidget* parent) :
        QMainWindow(parent),
        clientModel(0){
...
void CRYPTOSHARESGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    connect(toggleHideAction, &QAction::triggered, this, &CRYPTOSHARESGUI::toggleHidden);
 ...
 */
void CRYPTOSHARESGUI::connectActions()
{
...
void CRYPTOSHARESGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
#ifndef Q_OS_MAC
...
CRYPTOSHARESGUI::~CRYPTOSHARESGUI()
{
...
void CRYPTOSHARESGUI::handleRestart(QStringList args)
{
...
void CRYPTOSHARESGUI::createTrayIconMenu()
{
#ifndef Q_OS_MAC
    ...
    connect(trayIcon, &QSystemTrayIcon::activated, this, &CRYPTOSHARESGUI::trayIconActivated);
#else
    // Note: On macOS, the Dock icon is used to provide the tray's functionality.
    MacDockIconHandler* dockIconHandler = MacDockIconHandler::instance();
    connect(dockIconHandler, &MacDockIconHandler::dockIconClicked, this, &CRYPTOSHARESGUI::macosDockIconActivated);
...
#ifndef Q_OS_MAC
void CRYPTOSHARESGUI::trayIconActivated(QSystemTrayIcon::ActivationReason reason)
{
...
#else
void CRYPTOSHARESGUI::macosDockIconActivated()
 {
     show();
     activateWindow();
 }
...
void CRYPTOSHARESGUI::changeEvent(QEvent* e)
{
...
void CRYPTOSHARESGUI::closeEvent(QCloseEvent* event)
{
#ifndef Q_OS_MAC // Ignored on Mac
...
void CRYPTOSHARESGUI::messageInfo(const QString& text)
{
...
bool CRYPTOSHARESGUI::openStandardDialog(QString title, QString body, QString okBtn, QString cancelBtn)
{
...
void CRYPTOSHARESGUI::showNormalIfMinimized(bool fToggleHidden)
{
    if (!clientModel)
        return;
...
void CRYPTOSHARESGUI::toggleHidden()
{
    showNormalIfMinimized(true);
}

void CRYPTOSHARESGUI::detectShutdown()
{
    if (ShutdownRequested()) {
        if (rpcConsole)
            rpcConsole->hide();
...
void CRYPTOSHARESGUI::goToDashboard()
{
...
void CRYPTOSHARESGUI::goToSend()
{
    showTop(sendWidget);
}

void CRYPTOSHARESGUI::goToAddresses()
{
    showTop(addressesWidget);
}

void CRYPTOSHARESGUI::goToMasterNodes()
{
...
void CRYPTOSHARESGUI::goToSettingsInfo()
{
    navMenu->selectSettings();
...
void CRYPTOSHARESGUI::changeTheme(bool isLightTheme)
{
...
void CRYPTOSHARESGUI::resizeEvent(QResizeEvent* event)
{
    // Parent..
...
bool CRYPTOSHARESGUI::execDialog(QDialog *dialog, int xDiv, int yDiv)
{
    return openDialogWithOpaqueBackgroundY(dialog, this);
}

void CRYPTOSHARESGUI::showHide(bool show)
{
...
int CRYPTOSHARESGUI::getNavWidth()
{
...
bool CRYPTOSHARESGUI::addWallet(const QString& name, WalletModel* walletModel)
{
    ...
    connect(dashboard, &DashboardWidget::incomingTransaction, this, &CRYPTOSHARESGUI::incomingTransaction);

    return true;
}

bool CRYPTOSHARESGUI::setCurrentWallet(const QString& name)
{
    // Single wallet supported.
    return true;
}

void CRYPTOSHARESGUI::removeAllWallets()
{
    // Single wallet supported.
}

void CRYPTOSHARESGUI::incomingTransaction(const QString& date, int unit, const CAmount& amount, const QString& type, const QString& address)
{
...
static bool ThreadSafeMessageBox(CRYPTOSHARESGUI* gui, const std::string& message, const std::string& caption, unsigned int style)
{
