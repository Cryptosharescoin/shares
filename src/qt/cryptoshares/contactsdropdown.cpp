...
#include "qt/cryptoshares/contactdropdownrow.h"
...
ContactsDropdown::ContactsDropdown(int minWidth, int minHeight, CRYPTOSHARESGUI* _window, QWidget* _parent) : PWidget(_window, _parent)
{
