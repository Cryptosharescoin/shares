...
#include <QWidget>
#include <QString>
#include "qt/cryptoshares/prunnable.h"
...
class PWidget : public QWidget, public Runnable, public Translator
{
    Q_OBJECT
public:
    explicit PWidget(CRYPTOSHARESGUI* _window = nullptr, QWidget *parent = nullptr);
    explicit PWidget(PWidget *parent = nullptr);

    void setClientModel(ClientModel* model);
    void setWalletModel(WalletModel* model);

    CRYPTOSHARESGUI* getWindow() { return this->window; }
