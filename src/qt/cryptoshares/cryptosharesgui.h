...
#ifndef CRYPTOSHARES_CORE_NEW_GUI_CRYPTOSHARESGUI_H
#define CRYPTOSHARES_CORE_NEW_GUI_CRYPTOSHARESGUI_H
...
#include "qt/cryptoshares/navmenuwidget.h"
#include "qt/cryptoshares/topbar.h"
#include "qt/cryptoshares/dashboardwidget.h"
...
/**
  CRYPTOSHARES GUI main class. This class represents the main window of the CRYPTOSHARES UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class CRYPTOSHARESGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit CRYPTOSHARESGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~CRYPTOSHARESGUI();
...
#endif //CRYPTOSHARES_CORE_NEW_GUI_CRYPTOSHARESGUI_H
