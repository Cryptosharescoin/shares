...
#include "qt/cryptoshares/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/cryptoshares/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(CRYPTOSHARESGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
    ...
    messageInternal(CMD_REPLY, (tr("Welcome to the SHARES RPC console.") + "<br>" +
