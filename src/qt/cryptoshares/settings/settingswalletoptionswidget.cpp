...
#include "qt/cryptoshares/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/cryptoshares/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(CRYPTOSHARESGUI* _window, QWidget *parent) :
