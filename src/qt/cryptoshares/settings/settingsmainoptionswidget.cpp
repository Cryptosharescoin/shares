...
#include "qt/cryptoshares/settings/forms/ui_settingsmainoptionswidget.h"
#include "QListView"
...
SettingsMainOptionsWidget::SettingsMainOptionsWidget(CRYPTOSHARESGUI* _window, QWidget *parent) :
