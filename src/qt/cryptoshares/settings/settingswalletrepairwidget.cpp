...
#include "qt/cryptoshares/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/cryptoshares/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(CRYPTOSHARESGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to CRYPTOSHARESGUI::handleRestart()
