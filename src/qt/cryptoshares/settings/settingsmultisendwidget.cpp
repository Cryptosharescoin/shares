...
#include "qt/cryptoshares/settings/forms/ui_settingsmultisendwidget.h"
#include "qt/cryptoshares/settings/settingsmultisenddialog.h"
    ...
    ui(new Ui::SettingsMultisendWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("MultiSend allows you to automatically send up to 100% of your stake or masternode reward to a list of other CRYPTOSHARES addresses after it matures."));
