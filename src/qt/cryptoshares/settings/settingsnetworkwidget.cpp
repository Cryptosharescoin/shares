...
#include "qt/cryptoshares/settings/settingsnetworkwidget.h"
#include "qt/cryptoshares/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/cryptoshares/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(CRYPTOSHARESGUI* _window, QWidget *parent) :
