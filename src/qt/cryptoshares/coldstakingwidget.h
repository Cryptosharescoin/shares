...
#include "qt/cryptoshares/txviewholder.h"
#include "qt/cryptoshares/tooltipmenu.h"
#include "qt/cryptoshares/sendmultirow.h"
#include "qt/cryptoshares/coldstakingmodel.h"
...
public:
    explicit ColdStakingWidget(CRYPTOSHARESGUI* parent);
    ~ColdStakingWidget();
