...
#include "qt/cryptoshares/forms/ui_dashboardwidget.h"
...
DashboardWidget::DashboardWidget(CRYPTOSHARESGUI* parent) :
    PWidget(parent),
...
bool hasCharts = false;
    ...
    if (window)
        connect(window, &CRYPTOSHARESGUI::windowResizeEvent, this, &DashboardWidget::windowResizeEvent);
#endif
