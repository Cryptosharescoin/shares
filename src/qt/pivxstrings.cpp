...
QT_TRANSLATE_NOOP("pivx-core", "Error loading %s: Wallet requires newer version of CRYPTOSHARES"),
...
QT_TRANSLATE_NOOP("pivx-core", "Initialization sanity check failed. CRYPTOSHARES is shutting down."),
...
QT_TRANSLATE_NOOP("pivx-core", "Wallet needed to be rewritten: restart CRYPTOSHARES to complete"),
