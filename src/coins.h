...
public:
    ...
    /**
     * Amount of cryptoshares coming in to a transaction
...
// CRYPTOSHARES: When check is false, this assumes that overwrites are never possible due to BIP34 always in effect
