...
#ifndef CRYPTOSHARES_WALLET_H
#define CRYPTOSHARES_WALLET_H
...
public:
     ...
     * CRYPTOSHARES: group coins by pair <CTxDestination, Optional<CTxDestination>>. The optional destination
    ...
    /// Get 10000 SHARES output and keys which can be used for the Masternode
