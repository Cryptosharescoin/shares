...
#ifndef CRYPTOSHARES_ZSHARESTRACKER_H
#define CRYPTOSHARES_ZSHARESTRACKER_H
...
public:
    CzSHARESTracker(CWallet* parent);
    ~CzSHARESTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzSHARESWallet* zSHARESWallet = NULL);
...
#endif //CRYPTOSHARES_ZSHARESTRACKER_H
