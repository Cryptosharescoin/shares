...
#ifndef CRYPTOSHARES_LEGACY_ZPOS_H
#define CRYPTOSHARES_LEGACY_ZPOS_H

#include "stakeinput.h"
#include "main.h"
#include "txdb.h"

class CLegacyZSharesStake : public CStakeInput
{
private:
    uint32_t nChecksum;
...
public:
    ...
    explicit CLegacyZSharesStake(const libzerocoin::CoinSpend& spend);
    bool InitFromTxIn(const CTxIn& txin) override;
    bool IsZSHARES() const override { return true; }
...
#endif //CRYPTOSHARES_LEGACY_ZPOS_H
