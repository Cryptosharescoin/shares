...
#ifndef CRYPTOSHARES_ZSHARESWALLET_H
#define CRYPTOSHARES_ZSHARESWALLET_H
...
public:
    ...
    void GenerateDeterministicZSHARES(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZSHARES(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
...
#endif //CRYPTOSHARES_ZSHARESWALLET_H
