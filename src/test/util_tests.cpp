...
BOOST_AUTO_TEST_CASE(test_Capitalize)
{
    ...
    BOOST_CHECK_EQUAL(Capitalize("cryptoshares"), "Cryptoshares");
...
BOOST_AUTO_TEST_CASE(test_validateURL)
{
    ...
    BOOST_CHECK(validateURL("https://foo.bar/"));
    BOOST_CHECK(validateURL("http://cryptoshares.foo.bar"));
    BOOST_CHECK(validateURL("https://foo.bar/cryptoshares"));
    BOOST_CHECK(validateURL("https://foo.bar/cryptoshares/more/"));
    BOOST_CHECK(validateURL("https://142.2.3.1"));
    BOOST_CHECK(validateURL("https://foo_bar.cryptoshares.com"));
