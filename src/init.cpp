...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-conf=<file>", strprintf(_("Specify configuration file (default: %s)"), CRYPTOSHARES_CONF_FILENAME));
...
#ifndef WIN32
    strUsage += HelpMessageOpt("-pid=<file>", strprintf(_("Specify pid file (default: %s)"), CRYPTOSHARES_PID_FILENAME));
#endif
    ...
    strUsage += HelpMessageOpt("-mnconf=<file>", strprintf(_("Specify masternode configuration file (default: %s)"), CRYPTOSHARES_MASTERNODE_CONF_FILENAME));
        ...
        do {
            ...
            try {
                ...
                if (fReindexMoneySupply) {
                    ...
                    RecalculateSHARESSupply(1, fReindexZerocoin);
                }
