...
//
// The Masternode Class. It contains the input of the 10000 SHARES, signature to prove
...
public:
    ...
    static CAmount GetStakingReward(int nHeight);
    static CAmount GetMasternodeReward(int nHeight);
    /*
